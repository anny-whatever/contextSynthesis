...
export function RoleplayManagement({
  ...
  // Creation mode state
  const [creationMode, setCreationMode] = useState<"general" | "character">(
    "general"
  );
      ...
      if (response.success) {
        ...
        if (response.data) {
          setFormData((prev) => ({
            ...
            description: `Roleplay as ${formData.characterName}${
              formData.characterSource
                ? ` from ${formData.characterSource}`
                : ""
            }`,
            systemPrompt:
              response.data.systemPrompt ||
              `You are ${formData.characterName}. Roleplay as this character based on the researched knowledge.`,
          }));
        }
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setError(
        editingRoleplay ? "Error updating roleplay" : "Error creating roleplay"
      );
  ...
  const handleActivateRoleplay = async (roleplay: Roleplay) => {
    ...
    try {
      ...
      if (response.success) {
        setSuccessMessage(
          `Roleplay ${
            roleplay.isActive ? "deactivated" : "activated"
          } successfully`
        );
        loadRoleplays();
      } else {
              ...
              <Card>
                <CardContent className="py-12 text-center">
                  ...
                  <p className="mb-4 text-muted-foreground">
                    Create your first roleplay to get started with character
                    interactions
                  </p>
              ...
              roleplays.map((roleplay) => (
                ...
                >
                  <CardContent className="p-6">
                        ...
                        {characterKnowledge &&
                          showCharacterDetails[roleplay.id] && (
                            <div className="p-4 mt-4 rounded-lg bg-muted/50">
                              <h4 className="flex gap-2 items-center mb-2 font-medium">
                              ...
                              <div className="space-y-2 text-sm">
                                ...
                                <div>
                                  ...
                                  {characterKnowledge.chunks?.length || 0}{" "}
                                  chunks
                                </div>
                              </div>
                            </div>
                    ...
                    <div className="p-3 mt-4 text-sm rounded bg-muted/30">
          ...
          <div className="space-y-6">
            ...
            {!editingRoleplay && (
              <Tabs
                value={creationMode}
                onValueChange={(value) =>
                  setCreationMode(value as "general" | "character")
                }
              >
                ...
                <TabsContent value="general" className="space-y-4">
                  <div className="p-4 bg-gradient-to-r from-purple-50 to-blue-50 rounded-lg dark:from-purple-950/20 dark:to-blue-950/20">
                    <h4 className="flex gap-2 items-center mb-2 font-medium">
                      <Sparkles className="w-4 h-4" />
                      Manual Roleplay Creation
                    </h4>
                    <p className="text-sm text-muted-foreground">
                      Create a custom roleplay character by manually defining
                      their personality, behavior, and system prompt.
                    </p>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <Label htmlFor="isActive">
                        Activate this roleplay immediately
                      </Label>
                    </div>
                  </div>
                </TabsContent>
                ...
                <TabsContent value="character" className="space-y-4">
                  <div className="p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg dark:from-blue-950/20 dark:to-indigo-950/20">
                    <h4 className="flex gap-2 items-center mb-2 font-medium">
                      <Wand2 className="w-4 h-4" />
                      Character Research
                    </h4>
                    <p className="mb-4 text-sm text-muted-foreground">
                      Research a specific character to automatically generate
                      roleplay settings based on their knowledge.
                    </p>
                    ...
                    <div className="space-y-3">
                      ...
                      <Button
                        ...
                        disabled={
                          isResearching || !formData.characterName.trim()
                        }
                        className="w-full"
                      >
                        {isResearching ? (
                  ...
                  {(formData.name ||
                    ...
                    <div className="pt-4 space-y-4 border-t">
                      ...
                      <div>
                        <Label htmlFor="description-research">
                          Description *
                        </Label>
                        <Textarea
                      ...
                      <div>
                        <Label htmlFor="systemPrompt-research">
                          System Prompt *
                        </Label>
                        <Textarea
                      ...
                      <div className="flex items-center space-x-2">
                        <input
                          ...
                          className="rounded"
                        />
                        <Label htmlFor="isActive-research">
                          Activate this roleplay immediately
                        </Label>
                      </div>
                    </div>
